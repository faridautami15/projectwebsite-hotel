        ...
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Start Bootstrap</a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ml-auto">
              <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="#room">The Room</a>
              </li>
              <li class="nav-item">
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        <div class="intro-lead-in">Welcome To Hotel Del Luna!</div>
        <div class="intro-heading text-uppercase">It's Nice To Meet You</div>
        <a class="btn btn-warning btn-xl text-uppercase js-scroll-trigger" href="/pelanggan/input-pelanggan">Reservation</a>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3 class="section-subheading text-muted">Tell me your suggestions and impressions.</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
