...
<head>
    ...
    <!-- Bootstrap CSS
        ============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/bootstrap.min.css')}}">
    <!-- Bootstrap CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/font-awesome.min.css')}}">
	<!-- nalika Icon CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/nalika-icon.css')}}">
    <!-- owl.carousel CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{asset('css/nalika/owl.theme.css')}}">
    <link rel="stylesheet" href="{{asset('css/nalika/owl.transitions.css')}}">
    <!-- animate CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/animate.css')}}">
    <!-- normalize CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/normalize.css')}}">
    <!-- meanmenu icon CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/meanmenu.min.css')}}">
    <!-- main CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/main.css')}}">
    <!-- morrisjs CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/morrisjs/morris.css')}}">
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/scrollbar/jquery.mCustomScrollbar.min.css')}}">
    <!-- metisMenu CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/metisMenu/metisMenu.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/nalika/metisMenu/metisMenu-vertical.css')}}">
    <!-- calendar CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/calendar/fullcalendar.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/nalika/calendar/fullcalendar.print.min.css')}}">
    <!-- style CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/style.css')}}">
    <!-- responsive CSS
		============================================ -->
    <link rel="stylesheet" href="{{asset('css/nalika/responsive.css')}}">
    <!-- modernizr JS
		============================================ -->
    <script src="{{asset('js/nalika/vendor/modernizr-2.8.3.min.js')}}"></script>
</head>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                ...
                <strong><img src="images/logo.JPG" alt="" /></strong>-->
            </div>
			<div class="nalika-profile">
				<div class="profile-dtl">
					<!--<a href="#"><img src="{{asset('css/images/nalika/notification/4.jpg')}}" alt="" /></a>-->
					<h2>HOTEL DEL LUNA<span class="min-dtn"></span></h2>
				</div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								   ...
								   <span class="mini-click-non">Data Table</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a href="/petugas/read-petugas"><span class="mini-sub-pro">Petugas</span></a></li>
                                <li><a  href="/pelanggan/read-pelanggan"><span class="mini-sub-pro">Pelanggan</span></a></li>
                                <li><a  href="/pemesanan/read-pemesanan"> <span class="mini-sub-pro">Pemesanan</span></a></li>
                                <li><a  href="/pembayaran/read-pembayaran"><span class="mini-sub-pro">Pembayaran</span></a></li>
                                <li><a  href="/kamar/read-kamar"><span class="mini-sub-pro">Kamar</span></a></li>
                            </ul>
                        </li>
                        <!--<li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i> <span class="mini-click-non"></span></a>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <!--<a href="index.html"><img class="main-logo" src="{{asset('css/images/nalika/logo/logo.png')}}" alt="" /></a>-->
                    </div>
                </div>
            </div>
        </div>
                                                    ...
                                                    <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="message-menu">
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="{{asset('css/images/nalika/contact/1.jpg')}}" alt="">
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="{{asset('css/images/nalika/contact/4.jpg')}}" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Sulaiman din</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="{{asset('css/images/nalika/contact/3.jpg')}}" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="{{asset('css/images/nalika/contact/2.jpg')}}" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Data Tabel <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="/petugas/read-petugas">Petugas</a></li>
                                                <li><a href="/pelanggan/read-pelanggan">Pelanggan</a></li>
                                                <li><a href="/pemesanan/read-pemesanan">Pemesanan</a></li>
                                                <li><a href="/pembayaran/read-pembayaran">Pembayaran</a></li>
                                                <li><a href="/kamar/read-kamar">Kamar</a></li>
                                            </ul>
                                        </li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												...
												<p>Welcome to Hotel Del Luna <span class="bread-ntd"></span></p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-report">
                                            <a href="{{ url('/logout')}}">Keluar Akun</a> 
										</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="single-new-trend mg-t-30">
                            <a href="#"><img src="{{asset('css/images/nalika/new-product/5.png')}}" alt=""></a>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="personal-info-wrap">
                            <div class="widget-head-info-box">
                                ...
                                <img src="{{asset('css/images/nalika/notification/5.jpg')}}" class="img-circle circle-border m-b-md" alt="profile">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="author-widgets-single res-mg-t-30">
                            <div class="author-wiget-inner">
                                <div class="perso-img">
                                    <img src="{{asset('css/images/nalika/notification/6.jpg')}}" class="img-circle circle-border m-b-md" alt="profile">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="personal-info-wrap personal-info-ano res-mg-t-30">
                            <div class="widget-head-info-box">
                                ...
                                <img src="{{asset('css/images/nalika/contact/2.jpg')}}" class="img-circle circle-border m-b-md" alt="profile">
                                <div class="social-widget-result">
                                    <span>100 Tweets</span> |
                                    <span>350 Following</span> |
                                    <span>610 Followers</span>
...
-->
    ...
    <!-- jquery
		============================================ -->
    <script src="{{asset('js/nalika/vendor/jquery-1.12.4.min.js')}}"></script>
    <!-- bootstrap JS
		============================================ -->
    <script src="{{asset('js/nalika/bootstrap.min.js')}}"></script>
    <!-- wow JS
		============================================ -->
    <script src="{{asset('js/nalika/wow.min.js')}}"></script>
    <!-- price-slider JS
		============================================ -->
    <script src="{{asset('js/nalika/jquery-price-slider.js')}}"></script>
    <!-- meanmenu JS
		============================================ -->
    <script src="{{asset('js/nalika/jquery.meanmenu.js')}}"></script>
    <!-- owl.carousel JS
		============================================ -->
    <script src="{{asset('js/nalika/owl.carousel.min.js')}}"></script>
    <!-- sticky JS
		============================================ -->
    <script src="{{asset('js/nalika/jquery.sticky.js')}}"></script>
    <!-- scrollUp JS
		============================================ -->
    <script src="{{asset('js/nalika/jquery.scrollUp.min.js')}}"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="{{asset('js/nalika/scrollbar/jquery.mCustomScrollbar.concat.min.js')}}"></script>
    <script src="{{asset('js/nalika/scrollbar/mCustomScrollbar-active.js')}}"></script>
    <!-- metisMenu JS
		============================================ -->
    <script src="{{asset('js/nalika/metisMenu/metisMenu.min.js')}}"></script>
    <script src="{{asset('js/nalika/metisMenu/metisMenu-active.js')}}"></script>
    <!-- sparkline JS
		============================================ -->
    <script src="{{asset('js/nalika/sparkline/jquery.sparkline.min.js')}}"></script>
    <script src="{{asset('js/nalika/sparkline/jquery.charts-sparkline.js')}}"></script>
    <!-- calendar JS
		============================================ -->
    <script src="{{asset('js/nalika/calendar/moment.min.js')}}"></script>
    <script src="{{asset('js/nalika/calendar/fullcalendar.min.js')}}"></script>
    <script src="{{asset('js/nalika/calendar/fullcalendar-active.js')}}"></script>
	<!-- float JS
		============================================ -->
    <script src="{{asset('js/nalika/flot/jquery.flot.js')}}"></script>
    <script src="{{asset('js/nalika/flot/jquery.flot.resize.js')}}"></script>
    <script src="{{asset('js/nalika/flot/curvedLines.js')}}"></script>
    <script src="{{asset('js/nalika/flot/flot-active.js')}}"></script>
    <!-- plugins JS
		============================================ -->
    <script src="{{asset('js/nalika/plugins.js')}}"></script>
    <!-- main JS
		============================================ -->
    <script src="{{asset('js/nalika/main.js')}}"></script>
